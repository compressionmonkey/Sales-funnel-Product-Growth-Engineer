...
- A **search box** in the top bar finds leads by name — type and press
  Enter or click 🔍 (it queries Supabase, matching anywhere in the
  name, case-insensitively). Clear the box to see the full board again.
